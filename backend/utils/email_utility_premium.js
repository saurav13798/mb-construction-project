...
class EmailServicePremium {
    ...
    const mailOptions = {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 680px; margin: 0 auto; color: #1f2937;">
          <h2 style="color: #000000; border-bottom: 3px solid #f59e0b; padding-bottom: 12px;">New Contact Form Submission</h2>
          ...
          <div style="background-color: #ffffff; border: 1px solid #e6edf3; padding: 20px; border-radius: 8px;">
            ...
            <p style="line-height: 1.6; color: #111111;">${message}</p>
          </div>
  ...
  async sendAutoReply(contactData) {
    ...
    const mailOptions = {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 680px; margin: 0 auto; color: #1f2937;">
          <div style="background-color: #000000; color: #ffffff; padding: 22px; text-align: center; border-radius: 8px 8px 0 0;">
          ...
          <div style="padding: 30px 20px; background: #fff;">
            <h2 style="color: #000000;">Thank you for your inquiry!</h2>
            ...
            <div style="background-color: #f8fafc; padding: 20px; border-radius: 8px; margin: 20px 0;">
              ...
              <ul style="color: #111111; line-height: 1.6;">
